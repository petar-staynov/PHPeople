...
?>
    ...
    <div class="helpers" id="hi" style="position: absolute; color:white; top: 450px; opacity: 0; width: 90%;">
        <p style="padding-right: 30px; padding-left: 30px; font-size: 222%;"><img src="images/game-controller-icon.png" alt="About Image" width="444" height="444" style="float: left; margin-right: 30px;"><h1 style="text-align: center">About Us</h1>Tesla Motors, Inc. is an American automotive and energy storage company that designs, manufactures, and sells electric cars, electric vehicle powertrain components, and battery products.[5][6][7] Tesla Motors is a public company that trades on the NASDAQ stock exchange under the symbol TSLA.[8] During the first quarter of 2013, Tesla posted profits for the first time in its history.[9]
    ...
    <div class="helpers" id="hi2" style="position: absolute; color:white; top: 1000px; opacity: 0; right: 1px; width: 90%;">
        <p style="padding-left: 30px; padding-right: 30px;"><img src="images/game-controller-icon.png" alt="About Image" width="444" height="444" style="float: right; margin-left: 30px;"><h1 style="text-align: center">Need Help?</h1>Found in applications as diverse as industrial fans, blowers and pumps, machine tools, household appliances, power tools, and disk drives, electric motors can be powered by direct current (DC) sources, such as from batteries, motor vehicles or rectifiers, or by alternating current (AC) sources, such as from the power grid, inverters or generators. Small motors may be found in electric watches. General-purpose motors with highly standardized dimensions and characteristics provide convenient mechanical power for industrial use. The largest of electric motors are used for ship propulsion, pipeline compression and pumped-storage applications with ratings reaching 100 megawatts. Electric motors may be classified by electric power source type, internal construction, application, type of motion output, and so on.
